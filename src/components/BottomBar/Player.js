...
function Player() {
  ...
  return (
    <div className="block   md:flex md:justify-between md:px-4 md:items-center md:h-full">
      <div className="min-w-[11.25rem] w-full  md:w-[30%] ">
        {current && (
      ...
      <div className=" w-full max-w-[45.125rem] pt-2 md:w-[40%] flex flex-col items-center px-4 ">
      ...
      <div className="min-w-[11.25rem] w-full md:w-[30%] flex justify-center md:justify-end items-center">
        <button className="w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100">
